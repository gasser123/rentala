  ...
  return (
    <div className="mt-8 bg-white rounded-xl shadow-md overflow-hidden p-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div>
          <button className="bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center justify-center hover:bg-gray-700 hover:text-gray-50 cursor-pointer">
          ...
          <TableBody>
            {payments.map((payment) => (
              <TableRow key={payment.id} className="h-16">
                ...
                <TableCell>
                  <button className="border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center justify-center font-semibold hover:bg-gray-700 hover:text-gray-50 cursor-pointer">
