...
import { useCreatePropertyMutation } from "@/state/properties-api";
      ...
      <div className="bg-white rounded-xl p-6">
        <Form {...form}>
          ...
          >
            ...
            <Button
              type="submit"
              className="bg-gray-700 text-white w-full mt-8 cursor-pointer hover:bg-gray-800"
              disabled={isSubmitting}
            >
              {isSubmitting ? <Loader variation="linear" /> : "Add Property"}
            </Button>
          </form>
        </Form>
      </div>
